...
export default function BuildingManager({ isOpen, onClose, onBuildingSelected }) {
    ...
    return (
        <AnimatePresence>
            ...
            >
                ...
                >
                    {/* Header */}
                    <div className="relative p-8 bg-gradient-to-br from-primary-blue via-primary-purple to-primary-blue text-white overflow-hidden">
                    ...
                    <div className="p-8 overflow-y-auto max-h-[calc(90vh-140px)]">
                        {/* Form */}
                        <form onSubmit={handleSubmit} className="mb-8 bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl border-2 border-gray-100 shadow-lg">
